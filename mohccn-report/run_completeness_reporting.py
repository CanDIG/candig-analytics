...
def _run_sql_script(script_name):
    ...
    subprocess.run(
        ["docker", "cp", f"candigv2_postgres-db_1:/tmp/{stem_name}_count.csv", f"queries_results/{stem_name}_count.csv"])
    subprocess.run(["docker", "exec", "-i", "candigv2_postgres-db_1", "rm", f"/tmp/{stem_name}_count.csv"])
    subprocess.run(
        ["docker", "cp", f"candigv2_postgres-db_1:/tmp/{stem_name}_completeness.csv", f"queries_results/{stem_name}_completeness.csv"])
...
def get_minimal_completeness():
    ...
    minimal_completeness_df = pd.read_csv("queries_results/minimal_completeness.csv")
...
def get_comorbidity_completeness():
    ...
    comorbidity_comp_df = pd.read_csv("queries_results/fullsome_comorbidity_completeness.csv")
    comorbidity_count_df = pd.read_csv("queries_results/fullsome_comorbidity_count.csv").rename(columns={'count': 'total_count'})
...
def get_followups_completeness():
    followup_comp_df = pd.read_csv("queries_results/fullsome_followup_completeness.csv")
    followup_count_df = pd.read_csv("queries_results/fullsome_followup_count.csv").rename(columns={'count': 'total_count'})
...
def get_radiations_completeness():
    radiation_comp_df = pd.read_csv("queries_results/fullsome_treatments_radiation_completeness.csv")
    radiation_count_df = pd.read_csv("queries_results/fullsome_treatments_radiation_count.csv").drop('submitter_treatment_id',
                                                                                     axis=1).groupby(
...
def get_surgeries_completeness():
    surgery_comp_df = pd.read_csv("queries_results/fullsome_treatments_surgery_completeness.csv")
    surgery_count_df = pd.read_csv("queries_results/fullsome_treatments_surgery_count.csv").drop('submitter_treatment_id',
                                                                                 axis=1).groupby(
        ['program_id_id', 'submitter_donor_id'], as_index=False).sum().rename(columns={'count': 'total_count'})
    surgery_specimens = pd.read_csv("queries_results/fullsome_specimen_completeness.csv")
...
def get_sys_therapy_completeness():
    sys_therapy_comp_df = pd.read_csv("queries_results/fullsome_treatments_sys_therapy_completeness.csv")
    sys_therapy_count_df = (pd.read_csv("queries_results/fullsome_treatments_sys_therapy_count.csv").drop('submitter_treatment_id', axis=1).
...
def get_treatments_completeness():
    treatment_comp_df = pd.read_csv("queries_results/fullsome_treatments_completeness.csv")
    sys_therapy_count_df = pd.read_csv("queries_results/fullsome_treatments_sys_therapy_count.csv")
    radiation_count_df = pd.read_csv("queries_results/fullsome_treatments_radiation_count.csv").rename(columns={'count': 'total_count'})
    surgery_count_df = pd.read_csv("queries_results/fullsome_treatments_surgery_count.csv").rename(columns={'count': 'total_count'})
    treatment_count_df = pd.read_csv("queries_results/fullsome_treatments_count.csv").rename(
        columns={'count': 'total_count'})
...
def get_primary_diagnosis_completeness():
    pd_comp_df = pd.read_csv("queries_results/fullsome_primary_diagnosis_completeness.csv")
    pd_count_df = (pd.read_csv("queries_results/fullsome_primary_diagnosis_count.csv").rename(
        columns={'count': 'total_count'}))
...
def get_specimens_completeness():
    spec_comp_df = pd.read_csv("queries_results/fullsome_specimen_completeness.csv")
    spec_count_df = (pd.read_csv("queries_results/fullsome_specimen_count.csv").rename(columns={'count': 'total_count'}))
...
def get_samples_completeness():
    samp_comp_df = pd.read_csv("queries_results/fullsome_sample_completeness.csv")
    samp_count_df = (pd.read_csv("queries_results/fullsome_sample_count.csv").rename(columns={'count': 'total_count'}))
...
def get_donors_completeness():
    donor_comp_df = pd.read_csv("queries_results/fullsome_donor_completeness.csv")
    donor_count_df = (pd.read_csv("queries_results/fullsome_donor_count.csv").rename(columns={'count': 'total_count'}))
